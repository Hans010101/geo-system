...
function TronLogo({ className }: { className?: string }) {
  return <img src="/tron-logo.png" alt="TRON" className={className} />;
}
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-lg bg-primary flex items-center justify-center p-1.5">
              <TronLogo className="h-full w-full object-contain" />
            </div>
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed && (
                <div className="flex items-center gap-2 min-w-0">
                  <div className="h-7 w-7 rounded-md bg-sidebar-primary flex items-center justify-center shrink-0 p-1">
                    <TronLogo className="h-full w-full object-contain" />
                  </div>
          ...
          <div className="flex border-b h-14 items-center justify-between bg-background/95 px-2 backdrop-blur sticky top-0 z-40">
            <div className="flex items-center gap-2">
              ...
              <span className="tracking-tight text-foreground text-sm font-medium">
                {activeMenuItem?.label ?? "TRON GEO 系统"}
              </span>
            </div>
          </div>
        )}
